...
Serial.println( decision ) ;
    ...
    // ELSE IF GO STRAIT
    else if( decision == 1 && ( flag_ln == 1 || flag_ol == 1 || flag_or == 1 || flag_ot == 1 ) )
    {
        ...
        // RESET FLAGS
        //flag_ln = 0 ; // <-- DONT RESET LINE FOLLOW HERE THAT WAY IT "STICKS" FOR OTHER LF CONDITIONS THAT ARE LOOKING FOR IT.
        flag_ol = 0 ;
        flag_or = 0 ;
        flag_ot = 0 ;

        //return ;  // <-- THIS RETURN PREVENTS THE THE TAIL CODE IN THIS FUNCTION FROM PERFORMING.
                    // <-- THE   OL OR OT   SHOULD ALL BE FAR ENOUGH PAST THAT IT DEFAULTS BACK TO LINE FOLLOW.
